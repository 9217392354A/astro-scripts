...
#folder stuff
folder = '/Users/chrisfuller/Dropbox/phd/herchel/coma/deep-pacs/source-measurement/initial_outputs/'
outfolder = '/Users/chrisfuller/Dropbox/phd/herchel/coma/deep-pacs/source-measurement/catalogue_creation_phase/'
outname = 'deep_140414__best-flux__.fits'
#load catalogues one where all are forced as point to serve as the base catalogue
extended = at.Table(pj(folder,"deep_coma-100414-EXTENDED.fits"),type='fits')
point    = at.Table(pj(folder,"deep_coma-100414-POINT.fits")   ,type='fits')
