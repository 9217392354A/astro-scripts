...
###################### inputs ######################
rootSuper = "/Users/chrisfuller/Desktop/old/fornax/superCOSMOS/superCOSMOS-pgc/fits/"
rootFIR = "/Users/chrisfuller/Desktop/old/fornax/correct_pa/galaxies/"
#rootFIR = "/Volumes/niven.astro.cf.ac.uk/galaxies-initialmask"
outfolder = "/Users/chrisfuller/Desktop/all-detections/"
catfolder = "/Users/chrisfuller/Desktop/old/fornax/"
...
hdulist = pf.open(pj(catfolder,"HeFoCS-fluxes-120313_re-run.fits"))
cat = hdulist[1].data
##################### functions #####################
...
def findop(f,i):
    ...
    morph = f.field('MTYPE_PGC')[i]
    altname = f.field('NAMES')[i]
    ...
    for i in range(0,len(cat)):
        ...
        try:
            ...
            if dustOn ==1:
                ...
                plt.savefig(gal+"-"+band+"-dustcontour.eps")
