...
#Inputs
folder = "/Users/chrisfuller/Dropbox/phd/plots/morph"
...
bins_early_late_later_dwalf = [-3,0,2,10,21]
bina = bins_early_late_later_dwalf


mList =  ['','Dwarf' ,'', 'Early','', 'Late','', 'Irregulars']
mList_nos =  ['dE/dS0' , 'E/S', 'Sa/Sb/Sc/Sd', 'Sm/Im/dS']
...
plt.subplots_adjust(left=0.07, bottom=0.08, right=0.98, top=0.99, wspace=0.0, hspace=0.0)
fig.savefig(pj('/Users/chrisfuller/Desktop/','per_det_accros_hubble_seq.pdf'))
plt.show()
