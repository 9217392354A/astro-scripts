...
n=50000 #number of interations of monty carlo
...
for i in range(0,n):
	...
	loop_time = new - old
	old = new
	print 'single loop ', str(loop_time)
	print 'estimated completion time remaining: ', str(datetime.timedelta(seconds=loop_time*(n-i)))
