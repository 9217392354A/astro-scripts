...
if True:
	...
	ycols = ['SRF']
	ylabs = ['$\log_{10} (SFR / $M$_{\odot} $yr$^{-1}$)']
	ylims = [[-4.8, -1.4 ]]
	texts = ['Brinchmann et al. (2004)', 'Bell et al. (2003)']
	

#create figure and subplots
fig, subs = plt.subplots(nrows=1, ncols=len(xcols), sharex=False, sharey=True, squeeze=False, figsize = (8., 3.5), facecolor='w',edgecolor='w')
...
#printTable(coeffs_dict)
				...
				#sub.set_ylim(-12.8, -9.3)
##### plotting options
plt.subplots_adjust(left=0.11, bottom=0.17, right=0.97, top=0.97, wspace=0.0, hspace=0.0)
fig.savefig('/Users/chrisfuller/Dropbox/phd/papers/coma/SFR-density-v2.pdf')
plt.show()
