...
xlims = [[-0.7, 2.9], [-0.7,1.9], [-0.4,1.9], [-0.8, 0.9]] 
...
fig, subs = plt.subplots(nrows=1, ncols=len(xcols), sharex=False, sharey=False, squeeze=False, figsize = (8., 2.5), facecolor='w',edgecolor='w')
...
##### plotting options
plt.subplots_adjust(left=0.10, bottom=0.19, right=0.97, top=0.97, wspace=0.0, hspace=0.0)
fig.savefig('/Users/chrisfuller/Dropbox/phd/papers/coma/hi_firsel-density.pdf')
plt.show()
