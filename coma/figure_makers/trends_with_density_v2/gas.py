...
fig, subs = plt.subplots(nrows=len(ycols), ncols=len(xcols), sharex=False, sharey=False, squeeze=False, figsize = (8., 4.5), facecolor='w',edgecolor='w')
...
##### plotting options
plt.subplots_adjust(left=0.11, bottom=0.03, right=0.97, top=0.98, wspace=0.0, hspace=0.0)
fig.savefig('/Users/chrisfuller/Dropbox/phd/papers/coma/gas-density-v2.pdf')
plt.show()
