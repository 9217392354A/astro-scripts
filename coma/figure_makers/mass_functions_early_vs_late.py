...
def lmfitter(x , y, y_error):
	params = Parameters()
	params.add('phiStar', value=0.6, vary=True)
	params.add('LStar', value=5.6E7, vary=True)
		...
		for k in range(len(cats)):
			...
			if inputs[k] == 'cat':
				...
				for l in range(len(types)):
					...
					functionPlotter(subCat[para], volumes[k], bins, line_syles[k], types_col[l], sub)
...
#fig.savefig('/Users/chrisfuller/Dropbox/phd/papers/coma/dmass_Fucntion.pdf')
plt.show()
