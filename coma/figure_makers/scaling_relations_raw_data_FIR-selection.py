...
for j in range(j_range):
	for i in range(i_range):
		...
		if plots[j,i,1] != '': 
			...
			sub.xaxis.set_label_coords(0.5, -0.14)
...
plt.subplots_adjust(left=0.11, bottom=0.18, right=0.97, top=0.97, wspace=0.35, hspace=0.3)
#fig.savefig('/Users/chrisfuller/Dropbox/phd/papers/coma/Scaling_relations-fir.pdf')
plt.show()